...
CompletedText "Better-UI debug version successfully installed!"

# the file to write
OutFile "..\\dist\\installer\\Better-UI-debug-${PRODUCT_VERSION}.exe"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Better-UI-debug"
...
Function PatchFiles
  ...
  ExecWait 'find /C "./framework/better-ui-debug" "$unpackedDir\static\framework\$mainFile"' $0

  ${If} $0 > 0
    DetailPrint "Patching main file $unpackedDir\static\framework\$mainFile"
    FileOpen $4 "$unpackedDir\static\framework\$mainFile" a
    FileSeek $4 0 END
    FileWrite $4 'require(["./framework/better-ui-debug"]);'
    FileClose $4
  ${Else}
...
Function AddBetterUI
  ...
  File ..\dist\scripts\better-ui-debug.js
FunctionEnd
